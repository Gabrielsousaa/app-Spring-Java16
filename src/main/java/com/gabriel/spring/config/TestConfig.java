package com.gabriel.spring.config;
...
import com.gabriel.spring.entities.Payment;
...
import com.gabriel.spring.entities.enums.*;

import com.gabriel.spring.repositories.OrderRepository;
...
import com.gabriel.spring.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, Instant.parse("2019-06-20T21:53:07Z"), o1);//so funciona se o long == Long
        o1.setPayment(pay1);    
